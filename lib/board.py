...
class Board(chess.Board, object):
    ...
    # TODO: Is this wrong? Returns last element instead of move list
    ...
    def push(self, m):
        ...
        # does the move involve en passant or castling?
        is_complicated_hash = False
