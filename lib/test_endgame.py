...
class TestEndgame(unittest.TestCase):
	...
	def test_is_endgame(self):
		board = Board("1k6/8/8/8/8/3Q4/2K5/8 w - - 0 1")
	...
	def test_is_pawn_outside_of_square(self):
		board = Board("8/8/8/8/6k1/8/P7/7K w - - 0 1")
		pawn = chess.A2
	...
	def test(self):
		board = Board("8/7n/8/2p5/2k3p1/1r5p/K7/8 b - - 7 195")
		print()
		print(board)
		print("after knight move")
		print(endgame.evaluate_position(board, chess.BLACK))

		board = Board("5n2/8/8/2p5/6p1/1rk4p/K7/8 b - - 7 195")
		print()
		print(board)
