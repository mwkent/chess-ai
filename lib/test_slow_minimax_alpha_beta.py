...
class TestSlowMinimaxAlphaBeta(unittest.TestCase):
	...
	def test_king_blunder(self):
		board = chess.Board("r1bqkb1r/pppp1ppp/1nn1p3/4P3/2PP4/5N2/PP2BPPP/RNBQK2R b KQkq - 1 6")
		print("before move")
		move = minimax_alpha_beta.pick_move(board, 2)
		print(move)
		board = chess.Board("r1bq1b1r/ppppkppp/1nn1p3/4P3/2PP4/5N2/PP2BPPP/RNBQK2R w KQ - 2 7")
		print("after blunder")
		move = minimax_alpha_beta.pick_move(board, 1)
		print(move)
		board = chess.Board("r1bqkb1r/ppp2ppp/1nnpp3/4P3/2PP4/5N2/PP2BPPP/RNBQK2R w KQkq - 0 7")
	...
	def test_knight_blunder(self):
		board = chess.Board("4r1k1/pbQ2p1p/8/3p1p2/3P4/2Pq1P2/1r2N1PP/3RR2K b - - 1 23")
		print("depth 1")
		move = minimax_alpha_beta.pick_move(board, 1)
		print(move)
		print("depth 2")
	...
	def test_rook_fork_blunder(self):
		board = chess.Board("3r4/2p1k3/1p4p1/n1r2pq1/4p2p/4P2R/Q5P1/4BR1K b - - 31 67")
	...
	def test_knight_blunder3(self):
		board = chess.Board("rn1qkb1r/1p2nppp/p1pp4/4p3/6b1/4PN2/PPPPBPPP/RNBQ1RK1 w kq - 2 7")
		print("depth 1")
		move = minimax_alpha_beta.pick_move(board, 1)
		print(move)
		print("depth 2")
	...
	def test_queen_trapped(self):
		board = chess.Board("rnbqkb1r/pp3ppp/2pp1n2/8/B3p3/4PQ2/PPPP1PPP/RNB1K1NR w KQkq - 0 6")
		move = minimax_alpha_beta.pick_move(board, 3)
		self.assertNotEqual(move, chess.Move.from_uci("f3g3"))

	def test_king_rook_fork(self):
		board = chess.Board("r2qkb1r/pp3ppp/3p4/7n/1n2p3/4P2N/PPPP1PPP/RNB1K2R w KQkq - 1 10")
		move = minimax_alpha_beta.pick_move(board, 3)
	...
	def test_developing_queen(self):
		board = chess.Board("r1bqkbnr/pppp1ppp/2n5/8/4P3/8/PPP2PPP/RNBQKBNR b KQkq - 2 4")
		print("depth 1")
		move = minimax_alpha_beta.pick_move(board, 1)
		print(move)
		print("depth 2")
	...
	def test_knight_blunder4(self):
		board = chess.Board("r1b1kb1r/ppp1q1pp/5p2/3pP3/3P2n1/P4N1P/1P3PP1/RNBQK2R b KQkq - 0 11")
		print("depth 1")
		move = minimax_alpha_beta.pick_move(board, 1)
		print(move)
		print("depth 2")
		...
		print(move)
		#self.assertNotEqual(move, chess.Move.from_uci("f3e5"))
		board = chess.Board("r1b1kb1r/ppp1q1pp/5p1n/3pP3/3P4/P4N1P/1P3PP1/RNBQK2R w KQkq - 1 12")
		print("depth 1 after saving knight")
		move = minimax_alpha_beta.pick_move(board, 1)
		print(move)
		board = chess.Board("r1b1kb1r/ppp1q1pp/8/3pp3/3P2n1/P4N1P/1P3PP1/RNBQK2R w KQkq - 0 12")
	...
	def test_blunders_mate(self):
		board = chess.Board("r2qk2r/2pb4/p1n5/2BN3p/R2Pp2p/1P4P1/2P1PP2/3Q1RK1 w kq - 0 19")
		move = minimax_alpha_beta.pick_move(board, 2)
		self.assertNotEqual(move, chess.Move.from_uci("g3h4"))

	# Save bishop instead of castling
	def test_hanging_bishop(self):
		board = chess.Board("r2qk2r/ppp2ppp/2n2n2/3pp3/1b6/2PPP1PP/PP1NBP1R/R1BQK3 b Qkq - 0 9")
		move = minimax_alpha_beta.pick_move(board, 2)
	...
	def test_aggressive_knight_push(self):
		board = chess.Board("r1bqkbnr/ppp1n1pp/3p1p2/4p3/3P4/2N1BN2/PPP1PPPP/R2QKB1R w KQkq - 2 6")
		move = minimax_alpha_beta.pick_move(board, 2)
	...
	@unittest.skip("missing assert")
	def test_slow(self):
		board = chess.Board("r1bqkb1r/1pp2pp1/p1np3p/1B2n3/4P3/2N2N2/PPP2PPP/R1BQK2R w KQkq - 0 10")
		move = minimax_alpha_beta.pick_move(board, 1)
	...
	def test_only_move(self):
		board = chess.Board("rnbqk1nr/pppp1ppp/4p3/8/6Pb/3P1P2/PPP1P2P/RNBQKBNR w KQkq - 0 1")
		minimax_alpha_beta.pick_move(board, 10)		

	# Knight and pawns against bishop
	def test_finish_endgame_quickly(self):
		board = chess.Board("8/8/6p1/4np1p/1k6/p4p2/Bp3K2/8 w - - 0 78")
		num_moves = 0
	...
	def test_tactic(self):
		board = chess.Board("1k1r4/pp1Prpp1/2p2n1p/5Q2/8/5N2/qP3PPP/3R2K1 w - - 0 24")
		move = minimax_alpha_beta.pick_move(board, 1)
		self.assertEqual(move, chess.Move.from_uci("f5f4"))

	def test_skewer_tactic(self):
		board = chess.Board("1r6/1p3R2/p3R3/2k4p/P3PK2/8/8/1r6 w - - 3 37")
		move = minimax_alpha_beta.pick_move(board, 2)
	...
	def test(self):
		board = chess.Board("r2q3r/3kp2p/p2ppnp1/2p1P1Q1/Np6/3P4/PP3PPP/2R2R1K b - - 0 19")
		move = minimax_alpha_beta.pick_move(board, 1)
		move = minimax_alpha_beta.pick_move(board, 2)
		move = minimax_alpha_beta.pick_move(board, 3)
